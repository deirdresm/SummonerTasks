...
public protocol Bestiary: Decodable {
	var type: String { get set }
	var description: String { get set }
}

enum BestiaryFamily: String, ClassFamily {
	...
	func getType() -> NSManagedObject.Type {
		switch self {
		case .gameItem:
...
public class BestiaryItem: Decodable {
	...
	required convenience public init(from decoder: Decoder) throws {
		...
		self.fields = try container.decode(Dictionary.self, forKey: fields)
	}
	
}

public class BestiaryFileImport {
